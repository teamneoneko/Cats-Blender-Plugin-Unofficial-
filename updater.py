...
def check_for_update():
    ...
    if not get_github_releases('Darkblader24') and not get_github_releases('Yusarina'):
...
def get_github_releases(repo):
    ...
    try:
        ...
        with urllib.request.urlopen('https://api.github.com/repos/' + repo + '/Cats-Blender-Plugin-Unofficial-/tree/blender-40') as url:
...
def update_now(version=None, latest=False, dev=False):
    ...
    if dev:
        ...
        update_link = 'https://github.com/Yusarina/Cats-Blender-Plugin-Unofficial-/archive/blender-40.zip'
