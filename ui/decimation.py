...
class DecimationPanel(ToolPanel, bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = col.row(align=True)
        row.operator(Decimation.AutoDecimatePresetCatsGood.bl_idname)
        row.operator(Decimation.AutoDecimatePresetCatsExcellent.bl_idname)
        row.operator(Decimation.AutoDecimatePresetCatsQuest.bl_idname)
        row = col.row(align=True)
