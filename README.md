...
### DO NOT ASK FOR HELP IN THE OFFICIAL CATS DISCORD SERVER READ BELOW!
#### PLEASE DO NOT ASK FOR HELP FOR THIS VERSION OF CATS IN THE OFFICIAL CATS DISCORD. THIS CATS IS NOT THE OFFICIAL VERSION SO SUPPORT MAY NOT BE GIVEN IN THEIR DISCORD SERVER. IF YOU HAVE A BUG OR NEED HELP PLEASE START AN [ISSUE](https://github.com/Yusarina/Cats-Blender-Plugin-Unofficial-/issues) OR JOIN MY OWN [DISCORD](https://discord.yusarina.xyz) SERVER.
...
- Join my discord (This is for help only, do not report bugs/ issues in the discord): https://discord.yusarina.xyz
