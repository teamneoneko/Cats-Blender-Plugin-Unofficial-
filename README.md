# Cats Blender Plugin Blender 4.1 Dev.

## WARNING THIS IS ONLY FOR BLENDER 4.1 WHICH IS CURRENTLY IN ALPHA STAGE AND SHOULD NOT BE USED FOR PRODUCTION USE, THERE ARE BREAKING CHANGES FOR BLENDER 4.1 SO THIS VERSION WILL NOT WORK ON OLDER VERSION OF BLENDER!
### This is the Development version for blender 4.1 Alpha only! this version could be unstable or have issues, please use an released version if you encounter issues.
...
Blender 4.0 and 4.1 is also buggy and does have issues as well, we won't be recommending use of blender 4.x unto the first LTS comes out later this year.
...
- Blender 3.6 or above (run as administrator is recommended) (Please note some features may not work in version below 3.6).
   ...
   - Though I have updated CATS to Blender 4.0 and 4.1, I do not currently recommend using 4.0 or 4.1 as there multiple issues with MDD Tools, Blender 4.0 and 4.1 which cats uses.
